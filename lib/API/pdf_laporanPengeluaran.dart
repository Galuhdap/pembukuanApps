...
class PdfLaporanPengeluaran {
  ...
  Future<Uint8List> generate(LaporanPengeluaran invoice) async {
    final pdf = Document();
  ...
  //ini untuk header
  static Widget buildHeader(LaporanPengeluaran invoice) => Column(
  ...
  static Widget totals(LaporanPengeluaran lprn) => Column(
        children: [
          Container(
            child: Row(
  ...
  static Widget totals2(LaporanPengeluaran lprn) => Column(
        children: [
          Container(
            width: 475,
            child: Row(
  ...
  static Widget totals3(LaporanPengeluaran lprn) => Column(
        children: [
          Container(
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
...
// ini untuk Tabel
  static Widget buildTabel(LaporanPengeluaran invoice) {
    final headers = [
      'Tanggal',
      'Nama Barang',
      'Jumlah Pembelian',
  ...
  static Widget buildTabelPengeluaran(LaporanPengeluaran invoice) {
    final headers = [
      'Tanggal',
      'Nama Barang',
      'Harga',
...
//ini untuk kaki
  static Widget buildFooter(LaporanPengeluaran invoice) => Column(
  ...
  static buildSimpleText({
   ...
   static Widget buildTotals(LaporanPengeluaran invoice) {
    return Container(
