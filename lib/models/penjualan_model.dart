class PenjualanModel {
  ...
  String? kode_invoice, nama,nama_pembeli, tgl, produk, pembayaran ,createdAt , updatedAt;
 
  PenjualanModel(
    {this.id, this.kode_invoice ,this.nama,this.nama_pembeli,this.produk,this.jumlah_produk,this.total_produk,this.biaya_lain, this.pembayaran,this.subtotal , this.ongkos_kirim , this.potongan_harga ,this.tgl,this.total, this.createdAt , this.updatedAt}
  );
