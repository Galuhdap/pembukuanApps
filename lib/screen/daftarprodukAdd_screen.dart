...
class DaftarprodukAddScreen extends StatefulWidget {
  const DaftarprodukAddScreen({super.key});

  @override
  State<DaftarprodukAddScreen> createState() => _DaftarprodukAddScreenState();
}

class _DaftarprodukAddScreenState extends State<DaftarprodukAddScreen> {
